                ...
                >
                    ...
                    <div className="grid md:grid-cols-[1fr_2.5fr] gap-12 mb-24">
                        ...
                        <div className="pt-2">
                            ...
                            <div className="w-32 h-px bg-[#2e2e2e] mb-10" />

                            <div className="mb-10">
                                <p className="text-[#f5f5f5] text-lg mb-2 font-medium">Intermediate (PCM)</p>
                                <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4 text-[#7a7a7a] text-sm font-['Inter']">
                                    <span>2020 – 2022</span>
                                    <span className="hidden md:inline text-[#3d3d3d]">|</span>
                                    <span>Sunbeam School, Robertsganj, Uttar Pradesh</span>
                                </div>
                            </div>
                            ...
                            <div className="mb-4">
                                <p className="text-[#f5f5f5] text-lg mb-2 font-medium">Matriculation</p>
                                <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4 text-[#7a7a7a] text-sm font-['Inter']">
                                    <span>2019 – 2020</span>
                                    <span className="hidden md:inline text-[#3d3d3d]">|</span>
                                    <span>Sunbeam School, Robertsganj, Uttar Pradesh</span>
